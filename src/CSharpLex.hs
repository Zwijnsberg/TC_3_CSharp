...
lexTerminal = choice [t ParseLib.Abstract.<$ keyword s | (t,s) <- terminals]
...
lexicalScanner = lexWhiteSpace ParseLib.Abstract.*> greedy (lexToken ParseLib.Abstract.<* lexWhiteSpace) ParseLib.Abstract.<* eof
