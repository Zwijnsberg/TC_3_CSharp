...
pStat =  StatExpr <$> pExpr ParseLib.Abstract.<*  sSemi
     <|> StatIf     ParseLib.Abstract.<$ symbol KeyIf     <*> parenthesised pExpr <*> pStat <*> optionalElse
     <|> StatWhile  ParseLib.Abstract.<$ symbol KeyWhile  <*> parenthesised pExpr <*> pStat
     <|> StatReturn ParseLib.Abstract.<$ symbol KeyReturn <*> pExpr               ParseLib.Abstract.<*  sSemi
     <|> pBlock
...
pClass = Class ParseLib.Abstract.<$ symbol KeyClass <*> sUpperId <*> braced (many pMember)
